...
SECRET_KEY = 'django-insecure-am%*0_z=%#x+)j+r1u4u4bi3x+tun=xcl))o+@fyin2w^*ku%1'
...
STATIC_URL = '/statics/'
STATICFILES_DIRS=[os.path.join(BASE_DIR,'webApp/statics'),os.path.join(BASE_DIR,'webApp/media'),]
